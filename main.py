...
if not TMDB_API_KEY:
    # Don't crash import-time in production
    raise RuntimeError("TMDB_API_KEY missing. Put it in .env as TMDB_API_KEY=xxxx")

app = FastAPI(title="MatchMojo", version="3.0")
...
# Get the directory of the current script (e.g., main.py)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Point to the 'Model' subdirectory where your .pkl files are stored
MODEL_DIR = os.path.join(BASE_DIR, "Model")

# Full paths to each pickle file
